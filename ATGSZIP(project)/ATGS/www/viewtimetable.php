...
<div class="topnav" style="height:50px;">
		...
		<div class="title"><h2>View Time Table</h2></div>
						...
						<div id="TT" style="background-color: #FFFFFF">
							 <div class="table-responsive">
								<div class="record-but">
									<div class="">
										<table class="table table-striped table-bordered" id="employee_grid" class="display">
									...
									<tr>
										...
										<td style="text-align:center">8:00-8:40</td>
										<td style="text-align:center">8:40-9:20</td>
										<td style="text-align:center">9:20-10:00</td>
										<td style="text-align:center">10:00-10:15</td>
										<td style="text-align:center">10:15-10:55</td>
										<td style="text-align:center">10:55-11:35</td>
										<td style="text-align:center">11:35-12:15</td>
									</tr>
									<tr>
										<?php
										$table = null;
										...
										if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
											...
											echo '</table>';
											$sign = "Project By The Java Group(Govt. Polytechnic College Balaghat)";
